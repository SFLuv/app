...
- The improver workflow modal now shows a chunk-upload progress bar during photo transfer and swaps the form for a centered green “Submission Complete” success state with a large checkmark after the backend confirms step completion.
